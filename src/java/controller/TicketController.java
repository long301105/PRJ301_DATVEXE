...
public class TicketController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            }else if("showboughtticket".equals(getAction)){
                url=handleShowboutTicket(request,response);
            }
        } catch (Exception e) {
    ...
    private String handleShowboutTicket(HttpServletRequest request, HttpServletResponse response) {
        TicketDAO tdao= new TicketDAO();
        String url="admin/boughtticket.jsp";
        String scheduleID= request.getParameter("scheduleID");
        String message="";
        try{
            if(scheduleID.isEmpty() || scheduleID==null){
                return "seatSelection.jsp";
            }
            int scheduleid_value= Integer.parseInt(scheduleID);
            List<TicketDTO> boughtlist= tdao.getBoughtTicket(scheduleid_value);
            if(boughtlist.isEmpty() || boughtlist== null){
                message+="There is no one bought this ticket yet";
